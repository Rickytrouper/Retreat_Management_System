...
namespace Retreat_Management_System.Retreat_Management_DBDataSetTableAdapters {
    ...
    public partial class RetreatTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Retreat] ([RetreatName], [Description], [Location], [StartDate], [EndDate], [Price], [Capacity], [ImageURL], [ContactInfo], [CreatedBy], [OrganizerID], [DateCreated], [LastUpdated], [currentBookings]) VALUES (@RetreatName, @Description, @Location, @StartDate, @EndDate, @Price, @Capacity, @ImageURL, @ContactInfo, @CreatedBy, @OrganizerID, @DateCreated, @LastUpdated, @currentBookings);
SELECT RetreatID, RetreatName, Description, Location, StartDate, EndDate, Price, Capacity, ImageURL, ContactInfo, CreatedBy, OrganizerID, DateCreated, LastUpdated, currentBookings FROM Retreat WHERE (RetreatID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Retreat] SET [RetreatName] = @RetreatName, [Description] = @Description, " +
                "[Location] = @Location, [StartDate] = @StartDate, [EndDate] = @EndDate, [Price] " +
                "= @Price, [Capacity] = @Capacity, [ImageURL] = @ImageURL, [ContactInfo] = @Conta" +
                "ctInfo, [CreatedBy] = @CreatedBy, [OrganizerID] = @OrganizerID, [DateCreated] = " +
                "@DateCreated, [LastUpdated] = @LastUpdated, [currentBookings] = @currentBookings" +
                " WHERE (([RetreatID] = @Original_RetreatID) AND ([RetreatName] = @Original_Retre" +
                "atName) AND ([Location] = @Original_Location) AND ([StartDate] = @Original_Start" +
                "Date) AND ([EndDate] = @Original_EndDate) AND ([Price] = @Original_Price) AND ([" +
                "Capacity] = @Original_Capacity) AND ((@IsNull_ContactInfo = 1 AND [ContactInfo] " +
                "IS NULL) OR ([ContactInfo] = @Original_ContactInfo)) AND ((@IsNull_CreatedBy = 1" +
                " AND [CreatedBy] IS NULL) OR ([CreatedBy] = @Original_CreatedBy)) AND ((@IsNull_" +
                "OrganizerID = 1 AND [OrganizerID] IS NULL) OR ([OrganizerID] = @Original_Organiz" +
                "erID)) AND ((@IsNull_DateCreated = 1 AND [DateCreated] IS NULL) OR ([DateCreated" +
                "] = @Original_DateCreated)) AND ((@IsNull_LastUpdated = 1 AND [LastUpdated] IS N" +
                "ULL) OR ([LastUpdated] = @Original_LastUpdated)) AND ((@IsNull_currentBookings =" +
                " 1 AND [currentBookings] IS NULL) OR ([currentBookings] = @Original_currentBooki" +
                "ngs)));\r\nSELECT RetreatID, RetreatName, Description, Location, StartDate, EndDat" +
                "e, Price, Capacity, ImageURL, ContactInfo, CreatedBy, OrganizerID, DateCreated, " +
                "LastUpdated, currentBookings FROM Retreat WHERE (RetreatID = @RetreatID)";
        ...
        public virtual int Delete(int Original_RetreatID, string Original_RetreatName, string Original_Location, System.DateTime Original_StartDate, System.DateTime Original_EndDate, decimal Original_Price, int Original_Capacity, string Original_ContactInfo, global::System.Nullable<int> Original_CreatedBy, global::System.Nullable<int> Original_OrganizerID, global::System.Nullable<global::System.DateTime> Original_DateCreated, global::System.Nullable<global::System.DateTime> Original_LastUpdated, global::System.Nullable<int> Original_currentBookings) {
            ...
            if ((Original_currentBookings.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[17].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[18].Value = ((int)(Original_currentBookings.Value));
            }
            else {
        ...
        public virtual int Insert(string RetreatName, string Description, string Location, System.DateTime StartDate, System.DateTime EndDate, decimal Price, int Capacity, string ImageURL, string ContactInfo, global::System.Nullable<int> CreatedBy, global::System.Nullable<int> OrganizerID, global::System.Nullable<global::System.DateTime> DateCreated, global::System.Nullable<global::System.DateTime> LastUpdated, global::System.Nullable<int> currentBookings) {
            if ((RetreatName == null)) {
            ...
            if ((currentBookings.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[13].Value = ((int)(currentBookings.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> currentBookings, 
            ...
            if ((currentBookings.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(currentBookings.Value));
            }
            else {
            ...
            if ((Original_currentBookings.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[32].Value = ((int)(Original_currentBookings.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_LastUpdated, 
                    global::System.Nullable<int> Original_currentBookings) {
            return this.Update(RetreatName, Description, Location, StartDate, EndDate, Price, Capacity, ImageURL, ContactInfo, CreatedBy, OrganizerID, DateCreated, LastUpdated, currentBookings, Original_RetreatID, Original_RetreatName, Original_Location, Original_StartDate, Original_EndDate, Original_Price, Original_Capacity, Original_ContactInfo, Original_CreatedBy, Original_OrganizerID, Original_DateCreated, Original_LastUpdated, Original_currentBookings, Original_RetreatID);
        }
    }
